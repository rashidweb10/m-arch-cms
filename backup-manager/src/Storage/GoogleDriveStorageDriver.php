...
class GoogleDriveStorageDriver implements StorageDriver
{
    ...
    {
        $this->disk = config('backup-manager.destinations.google.disk', 'google');
        $this->basePath = trim(config('backup-manager.destinations.google.base_path', 'backups'), '/');
    }
