                ...
                <div class="row">
                    <div class="col-md-10">
                        <form class="row g-3 align-items-center">
                            ...
                            <div class="col-md">
                                <input type="text" name="search" class="form-control" value="{{request()->get('search')}}" placeholder="Search by name or slug">
                            </div>
                            <div class="col-md-1">
                    ...
                    <div class="col-md-2 text-end">
                        <button onclick="smallModal('{{url(route('blog-categories.create'))}}', 'Add New')"
