            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-control" placeholder="Enter schedule name" required>
                    </div>
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <select name="frequency" id="frequency" class="form-select" required onchange="toggleCronExpression()">
                            <option value="minutely" {{ old('frequency') == 'minutely' ? 'selected' : '' }}>Minutely</option>
                    ...
                    <div class="mb-3 form-group" id="cron_expression_group" style="display: {{ old('frequency') == 'custom' ? 'block' : 'none' }};">
                        <label for="cron_expression" class="form-label">Cron Expression <span class="text-danger">*</span></label>
                        <input type="text" id="cron_expression" name="cron_expression" value="{{ old('cron_expression', '* * * * *') }}" class="form-control" placeholder="* * * * *">
                ...
                <div class="card-body">
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-primary w-100">
                            <i class="ti ti-save"></i> Create Schedule
                        </button>
                    </div>
                </div>
            </div>
